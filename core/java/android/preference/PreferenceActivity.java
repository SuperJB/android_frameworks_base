 ...
 * old style of just showing a single preferences list. <div
 ...
 * </p>
 * </div> <a name="SampleCode"></a> <h3>Sample Code</h3>
 * <p>
 ...
 * </p>
 * {@sample development/samples/ApiDemos/src/com/example/android/apis/preference/
 * PreferenceWithHeaders.java activity}
 * <p>
 * The preference_headers resource describes the headers to be displayed and the
 * fragments associated with them. It is: {@sample
 * development/samples/ApiDemos/res/xml/preference_headers.xml headers}
 * <p>
...
public abstract class PreferenceActivity extends ListActivity implements
    ...
    /**
     * When starting this activity and using {@link #EXTRA_SHOW_FRAGMENT}, this
     * extra can also be specified to supply a Bundle of arguments to pass to
    ...
    /**
     * When starting this activity and using {@link #EXTRA_SHOW_FRAGMENT}, this
     * extra can also be specify to supply the title to be shown for that
     * fragment.
     */
    ...
    /**
     * When starting this activity and using {@link #EXTRA_SHOW_FRAGMENT}, this
     * extra can also be specify to supply the short title to be shown for that
     * fragment.
     */
     ...
     * used in conjunction with {@link #EXTRA_SHOW_FRAGMENT} to launch the
    ...
    // extras that allow any preference activity to be launched as part of a
    // wizard
    ...
    // specify custom text for the Back or Next buttons, or cause a button to
    // not appear
    ...
    public static final class Header implements Parcelable {
        ...
        /**
         * Resource ID of optional text to show as the short title in the bread
         * crumb.
         * 
        ...
        /**
         * Return the currently set title. If {@link #titleRes} is set, this
         * resource is loaded from <var>res</var> and returned. Otherwise
        ...
        /**
         * Return the currently set summary. If {@link #summaryRes} is set, this
         * resource is loaded from <var>res</var> and returned. Otherwise
         ...
         * {@link #breadCrumbTitleRes} is set, this resource is loaded from
         * <var>res</var> and returned. Otherwise {@link #breadCrumbTitle} is
         * returned.
         */
         ...
         * {@link #breadCrumbShortTitleRes} is set, this resource is loaded from
         * <var>res</var> and returned. Otherwise {@link #breadCrumbShortTitle}
         * is returned.
         */
    ...
    /**
     * Called to determine if the activity should run in multi-pane mode. The
     * default implementation returns true if the screen is large enough.
     */
     ...
     * implementation returns the value given in {@link #EXTRA_NO_HEADERS} or
     * false if it is not supplied. This is set to false, for example, when the
     * activity is being re-launched to show a particular preference activity.
     */
     ...
     * implementation simply returns the fragment of the first header. Note that
     * the returned Header object does not actually need to exist in your header
     * list -- whatever its fragment is will simply be used to show for the
     * initial UI.
     */
     ...
     * specify the header that should now be selected. The default
     * implementation returns null to keep whatever header is currently
     * selected.
     */
    ...
    /**
     * Called when the activity needs its list of headers build. By implementing
     ...
     * {@link #startWithFragment(String, Bundle, Fragment, int, int, int)} or
     * {@link #switchToHeader(Header)} as appropriate.
     * 
    ...
    /**
     * Called by
     * {@link #startWithFragment(String, Bundle, Fragment, int, int, int)} when
     ...
     * @param shortTitleRes Optional resource ID of short title to show for this
     *            item.
     ...
     * fragment. When launched in this mode, the header list will be hidden and
     * the given preference fragment will be instantiated and fill the entire
     * activity.
     * 
     * @param fragmentName The name of the fragment to display.
     * @param args Optional arguments to supply to the fragment.
     * @param resultTo Option fragment that should receive the result of the
     *            activity launch.
     * @param resultRequestCode If resultTo is non-null, this is the request
     *            code in which to report the result.
     * @param titleRes Resource ID of string to display for the title of this
     *            set of preferences.
     * @param shortTitleRes Resource ID of string to display for the short title
     *            of this set of preferences.
     */
    public void startWithFragment(String fragmentName, Bundle args,
    ...
    public void showBreadCrumbs(CharSequence title, CharSequence shortTitle) {
        if (mFragmentBreadCrumbs == null) {
            ...
            // For screens with a different kind of title, don't create
            // breadcrumbs.
            try {
    ...
    /**
     * Should be called after onCreate to ensure that the breadcrumbs, if any,
     * were created. This prepends a title to the fragment breadcrumbs and
     * attaches a listener to any clicks on the parent entry.
     * 
     ...
     * @param push If true, the current fragment will be pushed onto the back
     *            stack. If false, the current fragment will be replaced.
     */
    ...
    /**
     * Start a new fragment containing a preference panel. If the prefences are
     ...
     * @param resultTo Optional fragment that result data should be sent to. If
