...
#ifdef ALLWINNER
    int JNIMediaPlayerListener::parse3dFile(int type)
{
    JNIEnv *env = AndroidRuntime::getJNIEnv();
    return env->CallStaticIntMethod(mClass, fields.parse3dFile, mObject, type);
}
#endif
...
android_media_MediaPlayer_getTrackList(JNIEnv *env, jobject thiz)
{
    ...
    for(int i = 0; i < count; i++){
        jobject objTrackInfo = _composeObjTrackInfo(env, classTrackInfo, methodTrackInfo, ctrackList+i);
...
#ifdef ALLWINNER
    fields.parse3dFile = env->GetStaticMethodID(clazz, "parse3dFile",
                                               "(Ljava/lang/Object;I)I");
    if (fields.parse3dFile == NULL) {
        jniThrowException(env, "java/lang/RuntimeException", "Can't find MediaPlayer.parse3dFile");
        return;
    }
#endif
...
static JNINativeMethod gMethods[] = {
    ...
    {"getTrackList",           "()[Landroid/media/MediaPlayer$TrackInfo;", (void *)android_media_MediaPlayer_getTrackList},
